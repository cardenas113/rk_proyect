			...
			<main class="content">
					<div class="container ">
						<form class="row mt-2 needs-validation" >
							<div class="bg-white">
								<h1 class="mb-3  text-black">Asignacion</h1>
								<hr>
							</div>
							<div class="col-12">
								<label for="validationCustom04" class="form-label">Numero Apartamento</label>
							...
							<div class="row mt-3">
								<div class="col-md-12">
									<label for="validationCustom01" class="form-label">Inicio Asignación</label>
							...
							<div class="row mt-3">
								<div class="col-md-12">
									<label for="validationCustom01" class="form-label">Finalización  Asignación</label>
									<input type="date" class="form-control" required>
									<div class="valid-feedback">
										Looks good!
									</div>
							...
							<div class="row mt-3 justify-content-center">
								<div class="col col-button-asignation ">
									<div>
